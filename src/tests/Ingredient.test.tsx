...
// const useFridgeDataMock = vi.fn();
// vi.doMock("store/fridge/fridge", () => {
//   return { useFridgeData: useFridgeDataMock };
// });
...
describe("Ingredient", () => {
  ...
  it("shows checkmark if ingredient is present in user's fridge", () => {
    ...
    // useFridgeDataMock.mockReturnValue({ ingredients: [ingredient] });
  ...
  it("does not shows checkmark if ingredient is not present in user's fridge", () => {
    const ingredient = { id: 8, name: "juice", image: "juice.png" };
    useFridgeData.mockReturnValue({ ingredients: [ingredient] });
    // useFridgeDataMock.mockReturnValue({ ingredients: [ingredient] });
